...
public class FrequencyOfElement {
    ...
    public static void main(String[] args) {
        ...
        int[]array = {1,1,111,22,3,3,44,5,11,1,1};
...
Create a class named FrequencyOfElement:
			1.1 Create a method that passes two parameters: an integer array and an Integer
			element. The method returns the frequency of the given integer element from the
			integer array
