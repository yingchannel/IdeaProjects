...
public class SetPractice {
    ...
    public static void main(String[] args) {
        ...
        String [] arr1 = new HashSet<>( Arrays.asList(arr) ).toArray(new String[0]);

        System.out.println( Arrays.toString(arr1));

        String[] arr2 = new LinkedHashSet<>( Arrays.asList(arr) ).toArray(new String[0]);
        ...
        list.addAll(Arrays.asList(1000,300,1000,200,300,400,500,600,10,20,30,40,30,20,10));

        System.out.println("list = " + list);

        ArrayList<Integer> list1 = new ArrayList<>( new LinkedHashSet<>(list) );
